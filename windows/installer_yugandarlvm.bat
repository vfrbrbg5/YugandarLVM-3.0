:: Yugandar's Legacy Videomaker Installer
:: Author: yugandar's world animator#1822
:: License: MIT
title Yugandar's Legacy Videomaker [Initializing...]
...
title Yugandar's Legacy Videomaker Installer [Checking for Git...]
...
if !GIT_DETECTED!==n (
	title Yugandar's Legacy Videomaker Installer [Installing Git...]
	echo:
	echo Installing Git...
	echo:
...
echo Yugandar's Legacy Videomaker Installer
echo Project lead by Yugandar's World Animator. Installer is requested by NolanJ And Mohammedstar59.
echo:
echo Enter 1 to install Yugandar's Legacy Videomaker
...
git clone https://github.com/ykranimate2021-ga/YugandarLVM.git
cls
goto exit
